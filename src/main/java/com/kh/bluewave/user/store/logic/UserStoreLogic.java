...
public class UserStoreLogic implements UserStore{
	...
	@Override
	public int getFollowingCount(SqlSession session, String userId) {
		int result = session.selectOne("UserMapper.getFollowingCount", userId);
		return result;
	}

	@Override
	public int getFollowerCount(SqlSession session, String userId) {
		int result = session.selectOne("UserMapper.getFollowerCount", userId);
		return result;
	}
