...
public class NoticeBoardController {
	...
	public ModelAndView goNoticeBoard(ModelAndView mv) {
		mv.setViewName("notice/noticeBoard");
		
		return mv;
	}
	
	@RequestMapping(value="/noticeBoard.do", method=RequestMethod.POST)
	public ModelAndView selectNoticeBoard(ModelAndView mv) {
	...
	public ModelAndView image(MultipartHttpServletRequest request) throws Exception{
		...
		String uploadPath = "../resources/images/nUpload/" + fileReName; 
