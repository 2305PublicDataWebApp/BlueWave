...
<!--         <header></header> -->
        <main>
            <section id="main-container">
                ...
                <!-- 블루웨이브 챌린지 -->
                <form action="/challenge/showTag.do" method="post">
	                <section id="bluewave-chal" class="chal-section">
	                    <!-- 챌린지 진행도 선택 -->
	                    <select name="chalFinish" class="select-show-chal" onchange="">
	                        <option value="all">전체</option>
	                        <option value="N">진행 중인 챌린지</option>
	                        <option value="Y">완료된 챌린지</option>
	                    </select>
	...
	<!--                             </div> -->
                ...
                <form action="/challenge/showTag.do" method="post">
	                <section id="personal-chal" class="chal-section" style="display: none;" >
	                    ...
	                    <select name="chalFinish" class="select-show-chal">
	                        <option value="all">전체</option>
	                        <option value="N">진행 중인 챌린지</option>
	                        <option value="Y">완료된 챌린지</option>
	                    </select>
